        ...
        <div className='col-md-8'>
          ...
          <div className='row card-content'>
            <div className='col-md-6'>
              <img src={homecat1} className="brand-product" />
              <h5 className='text-center'>Bed Line</h5>
            </div>
            <div className='col-md-6'>
              <img src={homecat2} className="brand-product" />
              <h5 className='text-center'>Furnishing</h5>
            </div>
            <div className='col-md-6'>
              <img src={homecat3} className="brand-product" />
              <h5 className='text-center'>Art & Decore</h5>
            </div>
            <div className='col-md-6'>
              <img src={homecat4} className="brand-product" />
              <h5 className='text-center'>Lamps & Lightning</h5>
            </div>
            <div className='col-md-6'>
              <img src={homecat5} className="brand-product" />
              <h5 className='text-center'>Kitchen & Dinning</h5>
            </div>
            <div className='col-md-6'>
              <img src={homecat6} className="brand-product" />
