...
import mensethinic from '../../Assets/mens-ethinic.png';
import { AiOutlineHeart } from "react-icons/ai";
import { Link } from 'react-router-dom';

export default function Ethinic() {
  return (
    <div className='container-fluid Shirt-section'>
    <p><Link to={"/Dashboard"}>Home</Link> / <Link to={"/Men"}>Men</Link> / <b>Ethinic Casuals</b></p>
    <p><b>Men's Ethinic Wear</b> - 200 Items</p>
    <div className='row'>
                ...
                <div className='row'>
                    <div className='col-md-3 product-cat-col'>
                        <Link to={"/productdetail"}>
                            <img src={mensethinic} alt="something" width={"100%"} />
