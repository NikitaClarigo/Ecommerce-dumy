...
export default function Men() {
  return (
    <div>
      <img src={menbanner} className='banner' />
      <div className='section'>
        <h2 className='inner-heading'>Biggest deal on top brands</h2>
        <div className='row'>
          <div className='col-md-3'>
            <img src={brandproduct1} className="brand-product" />
            <img src={brand1} className="brand" />
            <h2 className='text-center'>30-60% Off</h2>
          </div>
          <div className='col-md-3'>
            <img src={brandproduct2} className="brand-product" />
            <img src={brand2} className="brand" />
            <h2 className='text-center'>30-60% Off</h2>
          </div>
          <div className='col-md-3'>
            <img src={brandproduct3} className="brand-product" />
            <img src={brand3} className="brand" />
            <h2 className='text-center'>30-60% Off</h2>
          </div>
          <div className='col-md-3'>
            <img src={brandproduct4} className="brand-product" />
      ...
      <div className='section'>
        ...
        <div className='row card-content'>
          <div className='col-md-3'>
            <img src={indian1} className="brand-product" />
            <h5 className='text-center'>All black indian wear</h5>
          </div>
          <div className='col-md-3'>
            <img src={indian2} className="brand-product" />
            <h5 className='text-center'>Short Kurta</h5>
          </div>
          <div className='col-md-3'>
            <img src={indian3} className="brand-product" />
            <h5 className='text-center'>Ethinic Casuals</h5>
          </div>
          <div className='col-md-3'>
            <img src={indian4} className="brand-product" />
