...
import mensshortkurta from '../../Assets/mens-shortkurta.png';
...
export default function Shortkurta() {
    return (
        <div className='container-fluid Shirt-section'>
            <p><Link to={"/Dashboard"}>Home</Link> / <Link to={"/Men"}>Men</Link> / <b>Short Kurta</b></p>
            <p><b>Men's Short Kurtas</b> - 200 Items</p>
            <div className='row'>
                        ...
                        <div className='row'>
                            <div className='col-md-3 product-cat-col'>
                                <Link to={"/productdetail"}>
                                    <img src={mensshortkurta} alt="something" width={"100%"} />
